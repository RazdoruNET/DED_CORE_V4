...
## Документация системы зажигания

Подробная техническая документация по ядру системы зажигания DED_CORE_V4:

- **[Полное руководство (CORE_IGNITION_GUIDE.md)](CORE_IGNITION_GUIDE.md)** - Полный документ в одном файле

### Разделенная документация по темам

- **[01. Математические основы](ignition/01-mathematical-foundations.md)** - Расчет RPM, угла опережения, времени искры, положения дросселя
- **[02. Временные диаграммы](ignition/02-timing-diagrams.md)** - Диаграммы работы датчика ВМТ, синхронизации зажигания, QuickShifter, сервопривода
- **[03. Блок-схемы](ignition/03-flowcharts.md)** - Алгоритмы основного цикла, расчета угла, фильтрации RPM, управления искрой
...
- **[06. Конфигурационные параметры](ignition/06-configuration-parameters.md)** - Основные параметры, функциональные флаги, параметры сервопривода
